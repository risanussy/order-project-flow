...
$stmt = $pdo->prepare("SELECT * FROM project WHERE code = 'Berlangsung'");
$stmt->execute();
...
<html lang="en">
  <head>
    ...
    <title>Project Berlangsung | Admin Project Flow</title>
  ...
  <body>
    ...
    <div class="container mt-5">
        <h3>Daftar Project yang Sedang Berlangsung</h3>
