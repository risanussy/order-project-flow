  ...
  <body>
    <div class="container pt-3">
        ...
        <ul class="nav mt-5 nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="step_four.php?project_id=<?= $_GET['project_id']; ?>">Step 4</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active text-primary" aria-current="page" href="#">Step 5</a>
            </li>
        </ul>
        <br>
